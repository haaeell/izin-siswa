                                    ...
                                    <style>
                                        ...
                                        * { box-sizing: border-box; margin: 0; padding: 0; }
                                        ...
                                        html, body {
                                            ...
                                            align-items: center; /* Memastikan body konten di tengah */
                                        }
                                        ...
                                        .barcode-section {
                                            width: 100%;
                                            display: flex;
                                            justify-content: center; /* Paksa posisi tengah horizontal */
                                            align-items: center;
                                        ...
                                        .barcode-section img {
                                            max-width: 95%; /* Mencegah gambar menyentuh garis pinggir */
                                            height: 12mm;
                                            display: block;
                                        }
